...
const HUB_TOP_ITEMS = [
  ...
  { id: 'shop',   label: '商店', icon: '<img class="hub-ico" src="assets/icons/icon_shop.png?v=13" alt="商店">', action: 'modal_shop' },
  { id: 'codex',  label: '图鉴', icon: '<img class="hub-ico" src="assets/icons/icon_codex.png?v=13" alt="图鉴">', action: 'modal_codex' },
  { id: 'worldboss', label: '世界BOSS', icon: '<img class="hub-ico" src="assets/icons/icon_worldboss.png?v=13" alt="世界BOSS">', action: 'go_worldboss' },
...
const HUB_BOTTOM_ITEMS = [
  ...
  { id: 'bag',    label: '背包', icon: '<img class="hub-ico" src="assets/icons/icon_bag.png?v=13" alt="背包">', action: 'modal_bag' },
